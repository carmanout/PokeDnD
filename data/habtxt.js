export const AbilitiesText= {
	...
	chlorophyll: {
		name: "Chlorophyll",
		desc: "Durante el clima soleado, la velocidad en pies de este pokemon se multiplica por 1.5. Si este pokemon tira iniciativa durante dia soleado, tira con ventaja.",
	...
	clearbody: {
		name: "Clear Body",
		shortDesc: "Los efectos de rivales no pueden reducir las estadisticas de este pokemon.",
	},
	cloudnine: {
		name: "Cloud Nine",
		shortDesc: "Si este pokemon está en combate, todos los efectos del clima se anulan.",
	...
	competitive: {
		name: "Competitive",
		desc: "Siempre que este Pokemon reciba una bajada de estadisticas por parte de un oponente, su INT sube 1 nivel durante el combate.",
	...
	contrary: {
		name: "Contrary",
		shortDesc: "Aumenta en vez de reducir sus estadisticas, y viceversa",
		gen7: {
	...
	cutecharm: {
		name: "Cute Charm",
		desc: "Siempre que es golpeado cuerpo a cuerpo por un movimiento, el atacante hace una tirada de salvación de carisma. Si falla, queda Enamorado.",
	...
	flashfire: {
		name: "Flash Fire",
		desc: "El usuario es inmune al daño por fuego. Los dados de daño se lanzan con ventaja si recibe un ataque de tipo fuego. Este efecto dura hasta sustiturse o debilitarse.",
	...
	heatproof: {
		name: "Heatproof",
		desc: "Este pokemon recibe la mitad de daño de los ataques de tipo fuego, redondeado hacia abajo, después de modificadores y efectividades.",
	...
	hospitality: {
		name: "Hospitality",
		shortDesc: "Cuando entra, el pokemon aliado a menos de 60 pies se cura 1d8+8 PG",
	...
	hydration: {
		name: "Hydration",
		desc: "Al final del turno, si está lloviendo, este Pokémon cura su estado.",
	...
	keeneye: {
		name: "Keen Eye",
		desc: "Previene de efectos que bajen las tiradas de impacto de este pokemon y las tiradas de salvación contra este pokemon.",
		shortDesc: "This Pokemon's accuracy can't be lowered by others; ignores their evasiveness stat.",
		gen5: {
	...
	marvelscale: {
		name: "Marvel Scale",
		shortDesc: "Si este pokemon tiene un efecto de estado, su clase de armadura aumenta en 3 puntos.",
	},
	megalauncher: {
		name: "Mega Launcher",
	...
	minus: {
		name: "Minus",
		desc: "Si otro pokemon con la habilidad de Plus o Minus está en el campo como aliado, la INT de este pokemon sube 2 puntos",
	...
	mummy: {
		name: "Mummy",
		desc: "Si un pokemon hace un ataque cuerpo a cuerpo a este pokemon sus habilidades son sustituidas por Mummy. Las siguientes habilidades no se ven afectadas: the As One, Battle Bond, Comatose, Disguise, Gulp Missile, Ice Face, Multitype, Mummy, Power Construct, RKS System, Schooling, Shields Down, Stance Change, Tera Shift, Zen Mode, or Zero to Hero Abilities.",
	...
	naturalcure: {
		name: "Natural Cure",
		shortDesc: "Si el pokemon es sustituido o retirado del combate, se curará de cualquier estado alterado que tenga.",
	...
	overgrow: {
		name: "Overgrow",
		desc: "Si la vida de este Pokémon es 1/3 o menos de su máximo, redondeado hacia abajo, su estadística ofensiva se suma 1d4 a su daño al impactar un ataque de tipo Planta.",
	...
	pixilate: {
		name: "Pixilate",
		desc: "Los ataques de tipo normal de este pokémon se convierten en tipo hada. Si no tenian STAB, lo obtienen. Estos ataques obtienen 1d4 adicional en sus ataques.",
	...
	pressure: {
		name: "Pressure",
		desc: "Los pokemon rivales en su presencia gastan dos usos en vez de uno de sus movimientos.",
	...
	rockhead: {
		name: "Rock Head",
		desc: "Los ataques que le hagan daño a si mismo, no le hacen daño.",
	...
	sandrush: {
		name: "Sand Rush",
		desc: "Durante tormenta de arena, la velocidad en pies de este pokemon se multiplica por 1.5. Si este pokemon tira iniciativa durante tormenta de arena, tiene ventaja.",
	...
	sapsipper: {
		name: "Sap Sipper",
		desc: "Este pokemon es inmune a los ataques de tipo planta, y si es golpeado por uno, su FUE sube un nivel durante el combate.",
	...
	serenegrace: {
		name: "Serene Grace",
		desc: "Durante el combate, todos los efectos secundarios de los movimientos de todos los pokemon se lanzan con ventaja. (Lanza dos dados y quédate con la mejor tirada)",
	...
	steadfast: {
		name: "Steadfast",
		shortDesc: "Si este pokemon retrocede, aumenta su DES en 1 y su velocidad en pies en 5 durante el combate.",
	},
	steamengine: {
		name: "Steam Engine",
	...
	torrent: {
		name: "Torrent",
		desc: "Si la vida de este Pokémon es 1/3 o menos de su máximo, redondeado hacia abajo, su estadística ofensiva se suma 1d4 a su daño al impactar un ataque de tipo Agua.",
	...
	unnerve: {
		name: "Unnerve",
		desc: "Los pokemon no pueden usar sus bayas mientras este Pokémon esté activo.",
	...
	waterabsorb: {
		name: "Water Absorb",
		desc: "Es inmune a los ataques de tipo agua. Si fuera a recibir daño de un ataque de agua, en vez de eso, restaura 1d10+6 de PG",
	...
	weakarmor: {
		name: "Weak Armor",
		desc: "Los ataques físicos que golpean a este pokemon, reducen su CA en 1. Al hacerlo, suma 1 a la destreza.",
